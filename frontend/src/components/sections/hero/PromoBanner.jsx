...
const slides = [
  ...
  {
    image: "public/hero/invest.png",
    // title: "Make it",
    // subtitle: "Best invest",
  },
  {
    image: "public/hero/presentation.png",
    // title: "for you",
    // subtitle: "Flash Presentations",
  },
]
        ...
        <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-2 z-10">
          {slides.map((_, i) => (
            <button
              ...
              className={`w-2 h-2 rounded-full transition ${i === currentSlide
