      ...
      {isOpen && (
        ...
        <Link to="/account/cancellations" className="flex items-center gap-2 hover:text-red-500">
          <Ban size={16} /> My Cancellations
            ...
            <li>
              <a href="/reviews" className="flex items-center gap-2 hover:text-red-500"><Star size={16}/> My Reviews</a>
              </li>
            <li>
              <button className="flex items-center gap-2 text-left w-full hover:text-red-500"><LogOut size={16}/> Logout</button>
              </li>
          </ul>
        </div>
